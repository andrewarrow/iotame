...
curl -H "Content-Type: application/json" -H "X-IOTA-API-Version: 1" -d '{"command": "getTrytes", "hashes": ["R9A9SDIVEENLHXNBRSHNTDMARBEOESYJR9HTDRYJAQLGOOQIPUVYTQOWY9OMAZYBHHNYBFLAWB9JA9999"]}' http://iota.bitfinex.com
